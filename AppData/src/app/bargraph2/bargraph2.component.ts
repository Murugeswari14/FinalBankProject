...
@Component({
  selector: 'app-bargraph2',
  templateUrl: './bargraph2.component.html',
  styleUrls: ['./bargraph2.component.css']
})
export class Bargraph2Component implements OnInit {
...
private drawBars(data: any[]): void {
  ...
  this.color = d3.scaleOrdinal()
    .range(['#FFA500','#2B4141', '34E4EA','#00FF00', '#FF0000', '#6b486b', '#FF00FF', '#d0743c', '#00FA9A','#74BDCB','#EFE7BC',
,'#FFA384','#0C2D48','#75E6DA','32021F','6C596E',
]);
